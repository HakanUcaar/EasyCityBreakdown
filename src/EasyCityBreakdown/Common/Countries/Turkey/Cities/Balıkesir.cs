...
{
    public class Balıkesir : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Balıkesir", "10", GeoLocation.From((37.000, 35.325))));
        public Balıkesir()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var city = ((IEnumerable)cities).Cast<dynamic>().Where(a => a.id == 10).FirstOrDefault();
