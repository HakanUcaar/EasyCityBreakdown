...
{
    public class Kırıkkale : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Kırıkkale", "71", GeoLocation.From((39.8417, 33.5139))));
        public Kırıkkale()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var requestIlceler = new RestRequest("https://online.baskentedas.com.tr/adres/ilceler?ilKodu=71");
            ...
            foreach (var ilce in ilceler)
            {
                ...
                requestBreakdowns.AddParameter("IlKodu", "71");
