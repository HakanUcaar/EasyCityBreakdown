...
{
    public class Sakarya : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Sakarya", "54", GeoLocation.From((40.7833, 30.4))));
        public Sakarya()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var breakdowns = ((IEnumerable)data).Cast<dynamic>().Where(x => x.ZIL == "SAKARYA");
