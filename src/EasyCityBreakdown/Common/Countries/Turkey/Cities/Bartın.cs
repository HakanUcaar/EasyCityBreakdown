...
{
    public class Bartın : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Bartın", "74", GeoLocation.From((41.6344, 32.3375))));
        public Bartın()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var requestIlceler = new RestRequest("https://online.baskentedas.com.tr/adres/ilceler?ilKodu=74");
            ...
            foreach (var ilce in ilceler)
            {
                ...
                requestBreakdowns.AddParameter("IlKodu", "74");
