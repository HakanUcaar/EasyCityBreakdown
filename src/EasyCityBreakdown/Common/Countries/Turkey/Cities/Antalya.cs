...
{
    public class Antalya : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Antalya", "07", GeoLocation.From((36.9081, 30.6956))));
        public Antalya()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            districts = ((IEnumerable)districts.adressSelectList).Cast<dynamic>().Where(a => a.UavtCode == "7");
