...
{
    public class Karabük : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Karabük", "78", GeoLocation.From((41.2, 32.6333))));
        public Karabük()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var requestIlceler = new RestRequest("https://online.baskentedas.com.tr/adres/ilceler?ilKodu=78");
            ...
            foreach (var ilce in ilceler)
            {
                ...
                requestBreakdowns.AddParameter("IlKodu", "78");
