...
{
    public class Bursa : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Bursa", "16", GeoLocation.From((40.1833, 29.0667))));
        public Bursa()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var city = ((IEnumerable)cities).Cast<dynamic>().Where(a => a.id == 16).FirstOrDefault();
