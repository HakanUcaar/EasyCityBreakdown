...
{
    public class Manisa : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Manisa", "45", GeoLocation.From((38.6333, 27.4167))));
        public Manisa()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            responseBreakdowns = ((IEnumerable)responseBreakdowns.results).Cast<dynamic>().Where(a => a.city == 45);
