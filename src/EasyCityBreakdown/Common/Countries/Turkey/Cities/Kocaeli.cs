...
{
    public class Kocaeli : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Kocaeli", "41", GeoLocation.From((40.7656, 29.9406))));
        public Kocaeli()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var breakdowns = ((IEnumerable)data).Cast<dynamic>().Where(x => x.ZIL == "KOCAELİ");
