...
{
    public class Denizli : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Denizli", "20", GeoLocation.From((37.7731, 29.0878))));
        public Denizli()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            responseBreakdowns = ((IEnumerable)responseBreakdowns.results).Cast<dynamic>().Where(a => a.city == 20);
