...
{    
    public class Tekirdağ : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Tekirdağ", "59", GeoLocation.From((40.9833, 27.5167))));
        public Tekirdağ()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var getMainPage = new RestRequest("http://www.tredas.com.tr/Planlikesintiler/tekirdag-59");
