...
{
    public class Isparta : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Isparta", "32", GeoLocation.From((37.7667, 30.55))));
        public Isparta()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            districts = ((IEnumerable)districts.adressSelectList).Cast<dynamic>().Where(a => a.UavtCode == "32");
