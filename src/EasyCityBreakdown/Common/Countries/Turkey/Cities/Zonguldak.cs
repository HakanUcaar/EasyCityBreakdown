...
{
    public class Zonguldak : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Zonguldak", "67", GeoLocation.From((41.45, 31.7833))));
        public Zonguldak()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var requestIlceler = new RestRequest("https://online.baskentedas.com.tr/adres/ilceler?ilKodu=67");
            ...
            foreach (var ilce in ilceler)
            {
                ...
                requestBreakdowns.AddParameter("IlKodu", "67");
