...
{
    public class Yalova : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Yalova", "77", GeoLocation.From((40.6556, 29.275))));
        public Yalova()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var city = ((IEnumerable)cities).Cast<dynamic>().Where(a => a.id == 77).FirstOrDefault();
