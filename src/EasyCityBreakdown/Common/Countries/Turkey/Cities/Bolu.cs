...
{
    public class Bolu : AbstractCity
    {
        public readonly List<Breakdown> Breakdowns;
        public static City Information => City.From(("Bolu", "14", GeoLocation.From((40.7333, 31.6))));
        public Bolu()
        {
            Info = Information;
        ...
        private List<Breakdown> GetElectricBreakdowns()
        {
            ...
            var breakdowns = ((IEnumerable)data).Cast<dynamic>().Where(x => x.ZIL == "BOLU");
